...
const ShoppingModal = () => {
    return (
        <div className='fixed inset-0 z-10 overflow-y-auto flex justify-end mt-16'>
        <div className="flex flex-col w-96 p-2 space-y-4 sm:p-10 bg-gray-200 dark:text-gray-800">
