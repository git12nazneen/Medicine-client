...
const Sidebar = ({ sideCollaps }) => {
  ...
  return (
    <aside className={`shadow-lg  h-screen ${sideCollaps ? "w-64" : "w-16"}` }>
            ...
            <li key={idx} className="p-2">
              <a
                ...
                onClick={(e) => {
                  ...
                  link.subLinks && handleClick(idx); // Toggle dropdown if subLinks exist
                }}
              ...
              >
                ...
                <h1 className='-rotate-90'><LuChevronLeft /></h1>
              </a>
