...
const DetailsCard = () => {
    ...
    return (
                    ...
                    <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                            ...
                            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                                ...
                                <p className="text-lg leading-8 text-gray-600 mt-2">
                                    Capsule Info: {capsuleInfo}
                                </p>
                                <p className="text-lg leading-8 text-gray-600 mt-2">
                                    Price: ${price} (Original Price: ${originalPrice}, Discount: {discount}%)
                                </p>
                                <p className="text-lg leading-8 text-gray-600 mt-2">
                                    Doses: {doses}
                                </p>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8 pb-8">
  ...
  <div className="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end">
    ...
    <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-[#0e7673] p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28">
