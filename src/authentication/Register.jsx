                ...
                <div className="relative flex items-center mt-4">
                  <span className="absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-3 text-gray-300 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v6m0 4v6m0 4h6m-6 0h-6m6 0v-4m0 4h6m-6 0h-6m6 0v-6m0-4v-6m0 0h-6m6 0h6" />
                    </svg>
                  </span>
                  <input
                    type="text"
                ...
                <div className="mt-8 md:flex md:items-center">
                  ...
                  >
                   Already have an account{" "}
                    <Link to="/login">
                      <a rel="noopener noreferrer" href="#" className="underline text-[#0e7673]">
                       Login
                      </a>
                    </Link>
                  </a>
          ...
          <div className="mt-8 md:mt-24 sm:flex sm:items-center">
            ...
            <div className="flex items-center mt-6 mb-5 -mx-2">
              <button
                ...
                type="button"
                className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-[#0e7673] rounded-lg hover:bg-[#113332] focus:bg-blue-400 focus:outline-none"
              >
